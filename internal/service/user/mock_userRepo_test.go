...
func (_m *mockUserRepo) Create(ctx context.Context, user *model.User) (*model.User, error) {
...
func (_m *mockUserRepo) GetByEmail(ctx context.Context, email string) (*model.User, error) {
